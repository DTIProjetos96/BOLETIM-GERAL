...
<head>
    ...
    <style>
        ...
        .month-box.active {
            ...
            /* Cor diferenciada para o mês atual ou com arquivos */
        }
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="boletimDropdown">
                            ...
                            <li>
                                <a class="dropdown-item" href="../boletim/ficha_individual/ficha_individual.php" target="content-frame">
                                    <i class="fa fa-address-card"></i> Ficha Individual
                                </a>
                            </li>
